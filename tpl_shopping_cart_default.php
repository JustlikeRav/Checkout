...
function changeselection() {
	...
	echo "<script>console.log('lol: " .$lol. "weight: '".$weight." );</script>";
	?>
...
var productIds = "<?php echo $productIds ?>";
...
if((country == "Z") || (zipcode == "") || (email == "")){
	...
	window.location.href = 'https://www.avenview.com/purchase/checkout.php?productNames='.concat(productNames,'&productPrices=',productPrices,'&productQty=',qtyList,'&totalPrice=',cartShowTotal,'&country=',country,'&zipcode=',zipcode,'&weight=',weight,'&email=',email,'&province=',province,'&productPricesTimesQty=',productPricesTimesQty,'&productIds=',productIds);

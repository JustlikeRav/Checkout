...
if((country == "Z") || (zipcode == "") || (email == "")){
	...
	window.location.href = 'https://www.avenview.com/purchase/checkout.php?productNames='.concat(productNames,'&productPrices=',productPrices,'&productQty=',qtyList,'&totalPrice=',cartShowTotal,'&country=',country,'&zipcode=',zipcode,'&weight=',weight,'&email=',email,'&productPricesTimesQty=',productPricesTimesQty);

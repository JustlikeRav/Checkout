<div id="cart-header">
	...
	<a href="<?php echo zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL'); ?>" class="button small">View Cart</a>&nbsp;&nbsp;<!--a href="<?php echo zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'); ?>" class="button small checkout"><?php echo HEADER_TITLE_CHECKOUT; ?></a-->
